...
- **Current condition:** Mengganti media yang sudah ada (mis. foto fasilitas E-UKS, foto guru dari Data Master > Guru) menulis berkas baru dengan kunci UUID baru lalu memindahkan referensi database; berkas lama tetap tinggal di volume tanpa ada yang menunjuknya. Tidak ada proses yang mengumpulkannya.
- **Evidence:** Inventaris read-only produksi 2026-09-15 setelah migrasi media legacy: volume `sismepda_media_data` memuat 43 berkas sementara hanya 40 kunci yang direferensikan database. Tiga berkas yatim yang sama seperti sebelum migrasi: `euks/facility/2e480a1e-7acb-4fab-b032-e381cb844864.jpg`, `euks/facility/64900353-df08-4c25-995c-437f2260e107.jpg`, `euks/facility/c50de1c3-c52d-472f-80f8-ec2fdd07877c.jpg`. Migrasi legacy tidak menambah berkas yatim. Konsisten dengan 11 `EUKS_FACILITY_PHOTO_UPDATED` atas 8 fasilitas di AuditLog.
