...
import { AlertTriangle, CheckCircle2, ChevronDown, ClipboardPenLine } from "lucide-react"
    ...
    <Card className="border-border/60 shadow-sm">
      ...
      <CardContent>
        {pending.length === 0 ? (
          ...
          <details className="group" open={pending.length <= 9}>
            <summary className="mb-4 flex min-h-11 list-none items-center justify-between gap-3 rounded-lg bg-secondary/50 px-3 py-2 text-sm font-medium text-foreground marker:hidden hover:bg-secondary">
              <span>Lihat {pending.length} kelas yang menunggu</span>
