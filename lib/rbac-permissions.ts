...
export const PERMISSIONS: readonly PermissionDefinition[] = [
  ...
  def({
    key: "reports.whatsapp.read",
    resource: "reports.whatsapp",
    action: "read",
    module: "attendance",
    label: "Lihat laporan WhatsApp",
  }),
  ...
  def({
    key: "students.master.write",
    resource: "students.master",
    action: "write",
    module: "students",
    label: "Tambah/ubah data induk siswa",
  ...
  def({
    key: "students.violations.write.assigned_classes",
  ...
  def({
    key: "students.violations.write.all",
    resource: "students.violations",
    action: "write",
    scope: "all",
    module: "students",
  ...
  def({
    key: "teachers.accounts.write",
    resource: "teachers.accounts",
    action: "write",
    module: "teachers",
    label: "Kelola akun guru (buat, kredensial, status, reset sandi)",
  ...
  def({
    ...
    action: "write",
    module: "homerooms",
    label: "Ubah penugasan wali kelas",
  ...
  def({
    key: "workbook.supervision.write",
    resource: "workbook.supervision",
    action: "write",
    module: "workbook",
