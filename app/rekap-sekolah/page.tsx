...
export default async function RekapSekolahPage({ searchParams }: { searchParams: Promise<{ date?: string }> }) {
  ...
  return (
    <PageContainer>
      <PageHeading
        title="Rekap Sekolah"
        description={`Ringkasan kehadiran seluruh siswa pada ${formatSchoolDate(date)}.`}
